                ...
                <?php if(Auth::check()): ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="<?php echo e(url('/changepassword')); ?>"><i class="fa fa-btn fa-sign-out"></i>Change Password</a></li>
                        </ul>
                    </li>
                <?php else: ?>
...
<?php echo $__env->make('footervarview', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

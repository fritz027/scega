                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-md-4 control-label">
                                ...
                                <label class="col-sm-4 table-bordered text-info text-right"> <?php echo e(number_format(($loans->loan_amount - $loans->payments),2)); ?></label>
                                ...
                                <table class="table">
                                    <table class="table table-bordered table-responsive table-striped">
                                        ...
                                        <?php $__currentLoopData = $loan_payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan_payment): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                            <tr>
                                                <td><?php echo e($loan_payment->tran_date); ?></td>
                                                ...
                                                <p class="hide"> <?php echo e($var = $var + $loan_payment->prin_payment); ?></p>
